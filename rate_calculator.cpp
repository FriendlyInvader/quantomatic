...
double calculators::rate_calculator::compound_pv(const double& fv, const double& rate, const int& number_of_periods = int{1}) {
    return fv / pow(1 + rate, number_of_periods);
}
